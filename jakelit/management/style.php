<?php
    ...
    session_start();
    $backgroundColor = isset($_GET['backgroundColor']) ? $_GET['backgroundColor'] : '#ff5733';
...
a {transition: all 0.3s ease 0s;text-decoration:none;color:<?php echo $backgroundColor ?>}
a:hover {
...
.nav.notika-top-nav .open>a, .nav.notika-top-nav .open>a:focus, .nav.notika-top-nav .open>a:hover {
    background: <?php echo $backgroundColor ?>;
    border-color: 0px solid <?php echo $backgroundColor ?>;
...
.conversation-list .odd .ctext-wrap:after {
    ...
    border-left-color: <?php echo $backgroundColor ?> !important;
    left: 100% !important;
    top: 20% !important;
}
...
.tooltip.right .tooltip-arrow{
    border-right-color: <?php echo $backgroundColor ?>;
}
.tooltip.bottom .tooltip-arrow{
	border-bottom-color: <?php echo $backgroundColor ?>;
}
.tooltip.top .tooltip-arrow{
	border-top-color: <?php echo $backgroundColor ?>;
}
.tooltip.left .tooltip-arrow{
	border-left-color: <?php echo $backgroundColor ?>;
}
.tooltip.in{
	opacity:1;
}
...
.multiupload-sys .dropzone.dropzone-custom{
	border: 2px dashed <?php echo $backgroundColor ?>;
}
.multiupload-sys i{
	font-size:30px;
	color:#333;
...
/*  35.  Form Element CSS
/*----------------------------------------*/
.nk-int-st input[type="text"], .nk-int-st textarea, .nk-int-st [type="number"], .nk-int-st [type="password"], .nk-int-st [type="color"]{
	box-shadow: none;
    border-top: 1px solid #ccc;
...
.main-menu-lv-int ul.main-menu-lv li ul.menu-dp-lt{
	...
	visibility:hidden;
	transition:all .4s ease 0s;
	border-top:2px solid <?php echo $backgroundColor ?>;
}
...
.form-single.widget-form input[type="text"]:focus{
	border: 0px solid <?php echo $backgroundColor ?>;
}
...
/*----------------------------------------*/
.mCS-light-1.mCSB_scrollTools .mCSB_dragger .mCSB_dragger_bar{ background-color: <?php echo $backgroundColor ?>; }
...
/* Custom CSS to hide Dropzone loader */
        .dz-progress {
...
#alert.show {
    top: 10%; /* Move to the middle of the screen */
    opacity: 1; /* Fade in */
...
#alertFile.show {
    top: 20%; /* Move to the middle of the screen */
    opacity: 1; /* Fade in */
    transform: translate(-50%, -50%);
    z-index:999999999;
}
...
#alertSuccess.show {
    top: 8%; /* Move to the middle of the screen */
    opacity: 1; /* Fade in */
    transform: translate(-50%, -50%);
    z-index:999999999;
}
...
#alertFailed.show {
    ...
    .custom-menu-content ul.notika-main-menu-dropdown .active a {
        background:<?php echo $backgroundColor ?>;
        border-radius: 5px;
        padding: 9px 14px;
        margin: 10px;
    ...
    .custom-menu-content ul.notika-main-menu-dropdown li a:hover{
        background:<?php echo $backgroundColor ?>;
        border-radius: 5px;
        padding: 9px 14px;
        margin: 10px;
