            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap ">
                        <div class="cmp-tb-hd">
                            <h2>Operating System (OS) Registration Form</h2>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<div class="form-example-int">
									<div class="form-group">
										<label>OS Name</label>
										<div class="nk-int-st">
											<input type="text" name="osName" id="osName" class="form-control input-sm" placeholder="Enter OS name" >
										</div>
									</div>
								</div>
							</div>
						...
						<center>
                            <div class="form-example-int mg-t-15">
                                <button id="btnOS" class="btn btn-success notika-btn-success">
                                    ...
                                    <tbody>
                                        <?php while($dataOS = mysqli_fetch_array($queryOS)) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo ucwords($dataOS['osName']) ?></td>
