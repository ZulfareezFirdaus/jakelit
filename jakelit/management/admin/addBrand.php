                    ...
                    <div class="form-example-wrap ">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<div class="form-example-int">
									<div class="form-group">
										...
										<div class="nk-int-st">
											<input type="text" name="brandName" id="brandName" class="form-control input-sm" placeholder="Enter Brand name" >
										</div>
									</div>
								</div>
							</div>
						...
						<center>
                            <div class="form-example-int mg-t-15">
                                <button id="btnLaptop" class="btn btn-success notika-btn-success">
                                ...
                                <tbody>
                                    <?php while($dataBrand = mysqli_fetch_array($queryBrand)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ucwords($dataBrand['brandName']) ?></td>
