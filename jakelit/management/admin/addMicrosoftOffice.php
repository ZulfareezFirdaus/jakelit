...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap ">
                        <div class="cmp-tb-hd">
                            <h2>Microsoft Office Registration Form</h2>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<div class="form-example-int">
									<div class="form-group">
										<label>Microsoft Office Name</label>
										<div class="nk-int-st">
											<input type="text" name="microsoftName" id="microsoftName" class="form-control input-sm" placeholder="Enter Microsoft office name" >
										</div>
									</div>
								</div>
							</div>
						...
						<center>
                            <div class="form-example-int mg-t-15">
                                <button id="btnMicrosoft" class="btn btn-success notika-btn-success">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Microsoft Office Records</h2>
                        </div>
                                ...
                                <tbody>
                                    <?php while($dataMicrosoft = mysqli_fetch_array($queryMicrosoft)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ucwords($dataMicrosoft['microsoftName']) ?></td>
    ...
    <script>
        $('#btnMicrosoft').click(function() {
            var status = "saveMicrosoft";
            var microsoftName = $("#microsoftName").val();
            var $btn = $(this);
            ...
            $('#microsoftName').on('input', function() {
               $('#microsoftName').css({
